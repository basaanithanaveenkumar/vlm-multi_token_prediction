...
from halo_vlm.models.ha_vlm import HaloVLM
...
def main() -> None:
    ...
    from halo_vlm.dataloader import create_vlm_dataloaders

    tokenizer = AutoTokenizer.from_pretrained("bert-base-uncased")
    model = HaloVLM(vocab_size=tokenizer.vocab_size, emb_dim=512)
